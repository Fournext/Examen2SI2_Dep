...
gestion = Gestion.objects.get(nombre="Gestion 2025")
...
with open('datos_boletin.csv', mode='a', newline='', encoding='utf-8') as file:
    ...
    for i in range(1000):
        user = Usuario.objects.create(
            username=f"estu2025_{i}",
            email=f"estu2025_{i}@mail.com",
            password="123456",
